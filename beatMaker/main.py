...
def draw_load_menu(index):
    ...
    exit_text = label_font.render('Close', True, white)
    screen.blit(exit_text, (WIDTH - 160, HEIGHT - 70))
    loading_btn = _extracted_from_draw_load_menu_11(100, 'Load Beat', 70)
    delete_btn = _extracted_from_draw_load_menu_11(400, 'Delete Beat', 385)
...
def _extracted_from_draw_load_menu_11(arg0, arg1, arg2):
    result = pygame.draw.rect(
        screen, gray, [WIDTH // 2 - arg0, HEIGHT * 0.87, 200, 100], 0, 5
    )
    loading_text = label_font.render(arg1, True, white)
    screen.blit(loading_text, (WIDTH // 2 - arg2, HEIGHT * 0.87 + 30))
    return result
